...
interface TipsHistoryModalProps {
  ...
  onClose: () => void;
  tips: any[];
  t: any; // Assuming t is a translation function
}

export function TipsHistoryModal({ isOpen, onClose, tips }: TipsHistoryModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-6 flex-shrink-0">
          <div className="relative flex-1">
            ...
            <Input
              placeholder="Search tips by net, percentage, or note..."
              value={searchTerm}
