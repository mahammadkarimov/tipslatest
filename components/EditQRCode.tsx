...
import { superAdminEditWaiter,superAdminGetWaiters ,superAdminEditQrCode , superAdminRestaurants} from '@/services/api/user';
...
export function EditQrCode({ isOpen, onClose, qrCode, onSave ,t}: EditQrCodeProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await superAdminEditQrCode(formData as any);
      if (!response.success) {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
               ...
               <div className='mt-10'>
               <QRDisplay2
                  title={qrCode.qr_code_id}
                  subtitle={qrCode.waiter_name}
